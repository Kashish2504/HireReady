  ...
  return (
    <>
      <div className="nav text-white">
        <nav className="h-16 flex items-center justify-between px-4 shadow-md bg-blue-950">
          ...
          <div className=" flex justify-around mx-2 px-2">
            <button className="text-xl my-1 mx-0 py-1 px-6 font-bold   border-b-4 border-transparent hover:rounded-xl hover:bg-blue-900/55">
          ...
          <div className="n-right flex justify-end">
            <button className="p-2 shadow-lg shadow-zinc-700/80 rounded-full bg-white-500 hover:bg-blue-900  transition">
